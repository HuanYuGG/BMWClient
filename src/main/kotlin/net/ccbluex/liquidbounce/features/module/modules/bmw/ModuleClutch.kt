...
import net.ccbluex.liquidbounce.features.module.modules.bmw.ModuleClutch.ScaffoldRotationConfigurable.RotationTimingMode.*
import net.ccbluex.liquidbounce.features.module.modules.bmw.ModuleClutch.ScaffoldRotationConfigurable.considerInventory
import net.ccbluex.liquidbounce.features.module.modules.bmw.ModuleClutch.ScaffoldRotationConfigurable.rotationTiming
...
object ModuleClutch : ClientModule("Clutch", Category.BMW) {
    ...
    object SimulatePlacementAttempts : ToggleableConfigurable(this, "SimulatePlacementAttempts", false) {
        ...
        internal val clicker = tree(Clicker(ModuleClutch, mc.options.useKey, false, maxCps = 100))
    ...
    private var ledge by boolean("Ledge", false)

    private val renderer = tree(PlacementRenderer("Render", false, this, keep = false))
    ...
    val timerHandler = tickHandler {
        if (timer != 1f) {
            Timer.requestTimerSpeed(timer, Priority.IMPORTANT_FOR_USAGE_1, this@ModuleClutch)
        }
    }
